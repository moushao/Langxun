...
public class SquareActivity extends BaseActivity implements SquareView {
    ...
    protected void initEventAndData() {
        initWidget();
        ((SquarePresenter) mPresenter).getSquareList(0);
    }
    ...
    private void initRefresh() {
        mRefreshLayout.setOnRefreshLoadmoreListener(new OnRefreshLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                ...
                ((SquarePresenter) mPresenter).getSquareList(page);
            }
    ...
    public static void startAction(Context mContext, String from) {
        Intent itt = new Intent(mContext, SquareActivity.class);
        Bundle bundle = new Bundle();
