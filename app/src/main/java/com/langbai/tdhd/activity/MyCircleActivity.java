...
public class MyCircleActivity extends BaseActivity implements CircleRecyclerView.
    ...
    private int page;
    private LoginResponseBean ownUser;
    ...
    protected void initEventAndData() {
        ownUser = (LoginResponseBean) getIntent().getExtras().getSerializable("OWN_USER");
        onTintStatusBar();
        initWidget();
    }
    ...
    private void initWidget() {
        ...
        if (ownUser.getUserInfoID() == UserHelper.getUserId()) {
            ...
            hostViewHolder = new HostViewHolder(this, null);
        }
        ...
        hostViewHolder.loadHostData(ownUser);
    ...
    private OnRefreshListener2 refreshListener = new OnRefreshListener2() {
        ...
        public void onRefresh() {
            isLoadMore = false;
            ((CirclePresenter) mPresenter).getMyOwnCircleList(0, ownUser.getUserInfoID());
        }
        ...
        public void onLoadMore() {
            ...
            ((CirclePresenter) mPresenter).getMyOwnCircleList(page, ownUser.getUserInfoID());
        }
    };
    ...
    private void gotoTakePhote() {
        PictureSelector.create(MyCircleActivity.this).openCamera(PictureMimeType.ofImage())// 单独拍照，也可录像或也可音频 
     ...
     * @param from     从哪儿跳来的
     */
    public static void startAction(Context mContext, LoginResponseBean user, String from) {
        Intent itt = new Intent(mContext, MyCircleActivity.class);
        Bundle bundle = new Bundle();
        bundle.putString(Constants.FROM, from);
        bundle.putSerializable("OWN_USER", user);
        itt.putExtras(bundle);
