package com.langbai.tdhd.parse;
...
public class ParseManager {
    ...
    public void onInit(Context context) {
        //parse包     compile 'com.parse:parse-android:1.15.7'
        
        Context appContext = context.getApplicationContext();
        Parse.enableLocalDatastore(appContext);
        //		Parse.initialize(context, ParseAppID, ParseClientKey);
        Parse.initialize(new Parse.Configuration.Builder(appContext).applicationId(ParseAppID).server(parseServer)
                .build());
    }
