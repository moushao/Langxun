...
import com.langbai.tdhd.mvp.model.SquareReleaseModel;
...
public class SquareReleasePresente extends BasePresenter<ReleaseView> {
    SquareReleaseModel mModel = new SquareReleaseModel();
