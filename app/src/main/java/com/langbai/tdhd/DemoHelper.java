...
import com.langbai.tdhd.db.DemoDBManager;
...
import com.langbai.tdhd.domain.InviteMessage;
import com.langbai.tdhd.domain.RobotUser;
import com.langbai.tdhd.event.CallReceiver;
import com.langbai.tdhd.parse.PreferenceManager;
import com.langbai.tdhd.parse.UserProfileManager;
...
public class DemoHelper {
    ...
    private GroupListtener groupListtener;
    ...
    private void showDialog() {
        ...
        if (!activity.isFinishing()) {
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    new AlertDialog(activity).setWidthRatio(0.7f).builder()
                            .hideTitleLayout()
                            .setCancelable(false)
                            .setMsg("你的帐号已在另一设备登录")
                            ...
                            .setNegativeButton(("确 定"), new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    LoginActivity.startAction(activity,TAG);
                                    activity.finish();
                                }
                            })
    ...
    class MyGroupChangeListener implements EMGroupChangeListener {
        ...
        public void onInvitationReceived(String groupId, String groupName, String inviter, String reason) {
            ...
            EventBus.getDefault().post(new EventMessage(EventMessage.GROUP_CHANGED, EventMessage.GROUP_CHANGED));
        }
        ...
        public void onAdminAdded(String groupId, String administrator) {
            ...
            Log.e("onAdminAdded:", administrator);
        }
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactAdded(String username) {
            ...
            EventBus.getDefault().post(new EventMessage(EventMessage.USER_CONTRACT, EventMessage.USER_CONTRACT));
        }
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    // 从消息的扩展属性里获取昵称头像
                    UserCacheManager.save(message.ext(), message.getFrom());
    ...
    public interface GroupListtener {
        void onAutoAcceptInvitationFromGroup();
    }

    public void setGroupListtener(GroupListtener listtener) {
        this.groupListtener = listtener;
    }
