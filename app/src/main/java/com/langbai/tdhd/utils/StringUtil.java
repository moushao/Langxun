...
public class StringUtil {
    ...
    public static String getResourceString(int strId) {
        String result = "";
        if (strId > 0) {
            result = MyApplication.getApplication().getResources().getString(strId);
        }
        return result;
    }
    ...
    public static String getResourceStringAndFormat(int strId, Object... objs) {
        String result = "";
        if (strId > 0) {
            result = String.format(Locale.getDefault(), MyApplication.getApplication().getResources().getString(strId), objs);
        }
        return result;
    }
