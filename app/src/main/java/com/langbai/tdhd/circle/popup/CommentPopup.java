...
public class CommentPopup extends BasePopupWindow implements View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.item_like:
                if (mOnCommentPopupClickListener != null) {
                    mOnCommentPopupClickListener.onLikeClick(v, mCircleBaseBean, hasLiked, friendPraiseID);
            ...
            case R.id.item_comment:
                if (mOnCommentPopupClickListener != null) {
                    mOnCommentPopupClickListener.onCommentClick(v, mCircleBaseBean);
                    dismissWithOutAnima();
                }
                break;
        }
    ...
    public void updateMomentInfo(@NonNull CircleBaseBean info) {
        this.mCircleBaseBean = info;
        hasLiked = false;
    ...
    public interface OnCommentPopupClickListener {
        void onLikeClick(View v, @NonNull CircleBaseBean info, boolean hasLiked, Long friendPraiseID);

        void onCommentClick(View v, @NonNull CircleBaseBean info);
    }
