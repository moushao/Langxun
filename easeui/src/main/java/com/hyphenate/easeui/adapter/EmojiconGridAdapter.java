...
public class EmojiconGridAdapter extends ArrayAdapter<EaseEmojicon> {
    ...
    public EmojiconGridAdapter(Context context, int textViewResourceId, List<EaseEmojicon> objects, EaseEmojicon.Type
            emojiconType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (EaseSmileUtils.DELETE_KEY.equals(emojicon.getEmojiText())) {
            ...
            if (emojicon.getIcon() != 0) {
                ...
                Glide.with(getContext()).load(emojicon.getIconPath()).apply(new RequestOptions().placeholder(R
                        .drawable.ease_default_expression).diskCacheStrategy(DiskCacheStrategy.ALL).error(R.drawable
                        .ease_default_expression).priority
