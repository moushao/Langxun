        ...
        if (userAvatarView != null) {
            ...
            if (message.direct() == Direct.SEND) {
                EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(),
                        message.getChatType() == EMMessage.ChatType.Chat? R.drawable.ease_default_avatar:R.drawable.ease_group_icon, 
                        userAvatarView);
                EaseUserUtils.setUserNick(message.getFrom(), usernickView);

            } else {
                EaseUserUtils.setUserAvatar(context, message.getFrom(), message.getChatType() == EMMessage.ChatType.Chat? R.drawable.ease_default_avatar:R.drawable.ease_group_icon, userAvatarView);
                EaseUserUtils.setUserNick(message.getFrom(), usernickView);
            }
        }
