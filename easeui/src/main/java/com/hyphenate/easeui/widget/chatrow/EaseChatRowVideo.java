...
public class EaseChatRowVideo extends EaseChatRowFile {
    ...
    protected void onBubbleClick() {
        ...
        localFilePath = videoBody.getLocalUrl();
        if (localFilePath != null && new File(localFilePath).exists()) {
            JZVideoPlayerStandard.startFullscreen(getContext(), JZVideoPlayerStandard.class, localFilePath, "");
        } else {
     ...
     * @param message
     */
    private void showVideoThumbView(final String localThumb, final ImageView iv, String thumbnailUrl, final EMMessage
            message) {
