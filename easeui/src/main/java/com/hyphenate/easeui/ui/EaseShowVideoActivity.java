...
public class EaseShowVideoActivity extends EaseBaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (localFilePath != null && new File(localFilePath).exists()) {
            JZVideoPlayerStandard.startFullscreen(this, JZVideoPlayerStandard.class, localFilePath,"");
...
//			finish();
	...
	private void showLocalVideo(String localPath){
        JZVideoPlayerStandard.startFullscreen(this, JZVideoPlayerStandard.class, localPath,"");
