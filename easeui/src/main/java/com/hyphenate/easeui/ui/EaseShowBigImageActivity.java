...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downlown = (ImageView) findViewById(R.id.downlown);
        backTv = (TextView) findViewById(R.id.backs);
        ...
        if (uri != null && new File(uri.getPath()).exists()) {
            ...
            if (bitmap == null) {
                ...
                downlown.setVisibility(View.VISIBLE);
            }
        } else if (msgId != null) {
            downloadImage(msgId);
        } else {
        ...
        downlown.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (EaseImageUtils.saveImageToGallery(downlown.getContext(), bitmap)) {
                    
                    Toast.makeText(EaseShowBigImageActivity.this, "图片保存成功", Toast.LENGTH_SHORT).show();
                    downlown.setVisibility(View.INVISIBLE);
                }
            }
        });
